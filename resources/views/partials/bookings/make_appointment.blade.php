<div class="col-md-12 mt-3">
    <div class="alert alert-info text-center" role="alert">
        <strong>Info!</strong> You can make a payment at the counter.
    </div>
</div>

<div class="col-md-4 mt-3">
    <div class="card">
        <div class="card-header bg-secondary text-white text-center"><strong>Scheduling Details</strong></div>
            ...
            <form action="/appointments" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-12">
                        <textarea name="patient_condition" class="form-control" placeholder="explain your condition..." autofocus required></textarea>
